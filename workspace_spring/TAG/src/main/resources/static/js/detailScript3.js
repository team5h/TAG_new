...
var concertYear = dateSplit[0]; //2022
var concertMonth = dateSplit[1]; //12
var concertDay = dateSplit[2]; 	//24
...
let date = new Date(),
currYear = date.getFullYear(), // 2022년
currMonth = date.getMonth();  //  12월
