...
/* 아이디 일치 불일치 디스플레이 */
.id_input  {color:#FF0066; display: ; margin-top:5px;}
...
<!-------------------- body start ---------------------->
     	...
     	<div class="jform">
		<form id = "form" method="post" action="<c:url value='/memberupdateGproc'/>" onsubmit="return updateGcheck()">
        <h1>회원정보 수정</h1>
        
            <label for="address2" class="form-label mt-4">아이디</label>
        	<div class="textbox">
				<input type="text" id="m_id" name="m_id" value="${dto.m_id}" onclick="clickId();" readonly>
				<!-- id ajax 중복체크 -->
				<div>
				<span class="id_input">아이디는 변경할 수 없습니다.</span>
				</div>
			</div>
        	...
        	<div class="textbox">
	        	<input type="password" id="m_pwCheck" name="m_pwCheck" maxlength="15" value="${dto.m_pw}">
	        	<div>
            ...
            <div class="textbox">
                <input type="password" id="m_pw" name="m_pw" maxlength="15" oninput="joincCheckPw()" value="${dto.m_pw}">
               	<div>
			...
			<div class="textbox">
                <input type="text" id="m_name" name="m_name" maxlength="40" value="${dto.m_name}">
                <div>
			...
			<div class="textbox">
                <input type="text" id="nickname" name="nickname" maxlength="40" value="${dto.nickname}">
                <div>
            ...
            <div class="textbox">
                 <select id="gender" name="gender">
                    ...
                    <option value="M" ${dto.gender=='M' ? 'selected' : ''}>남성</option>
	             </select>
                <div>
             ...
             <div>
             <input type="date" id="birth" name="birth" min="1940-01-01" value="${dto.birth}">
             <div>
...
<!--              	<input type="text" id="joinbirth" name="joinbirth" maxlength="4" placeholder="년(4자)" size="6" >
			...
			<div>
	            <input type="text" id="m_email" name="m_email" maxlength="30" oninput="checkEmail()" value="${dto.m_email}">
	            <div>
			...
			<div class="textbox">
	            <input type="text" id="m_tel" name="m_tel" value="${dto.m_tel}">
	            <div>
			...
			<div class="addressbox">
                <input type="text" size="50" id="m_zipcode" name="m_zipcode" placeholder="우편번호" value="${dto.m_zipcode}" readonly/>
			...
			<div class="addressbox">
                <input type="text" size="50" id="m_addr1" name="m_addr1" placeholder="주소" value="${dto.m_addr1}"/>
			</div>
			
			<div class="addressbox">
                <input type="text" size="50" id="m_addr2" name="m_addr2" placeholder="상세 주소" value="${dto.m_addr2}"/>
                <div>
            ...
            <br>
            <div>
            <input id="joinGbtn" type="submit" value="수정하기"/> 
            </div>
        </form>
